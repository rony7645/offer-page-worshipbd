...
*/
    var e, i, s, n, o, a, r, l, h = 0, c = Array.prototype.slice;
    t.cleanData = (r = t.cleanData,
    function(e) {
        var i, s, n;
    ...
    t.widget.extend = function(e) {
        for (var i, s, n = c.call(arguments, 1), o = 0, a = n.length; o < a; o++)
            for (i in n[o])
                s = n[o][i],
                n[o].hasOwnProperty(i) && void 0 !== s && (t.isPlainObject(s) ? e[i] = t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s) : e[i] = s);
        return e
    }
    ,
    ...
    t.Widget.prototype = {
        ...
        option: function(e, i) {
            ...
            if ("string" == typeof e) {
                ...
                s.length) {
                    for (o = 0,
                    n = a[e] = t.widget.extend({}, this.options[e]); o < s.length - 1; o++)
                        n[s[o]] = n[s[o]] || {},
                        n = n[s[o]];
                    if (e = s.pop(),
                    1 === arguments.length)
...
*/
    function() {
        ...
        t.fn.position = function(e) {
            ...
            e = t.extend({}, e);
            var l, d, p, f, g, m, v, b, $ = t(e.of), y = t.position.getWithinInfo(e.within), _ = t.position.getScrollInfo(y), w = (e.collision || "flip").split(" "), k = {};
            ...
            g.top += l[1],
            this.each(function() {
                var n, o, a = t(this), r = a.outerWidth(), h = a.outerHeight(), m = u(this, "marginLeft"), v = u(this, "marginTop"), b = r + m + u(this, "marginRight") + _.width, x = h + v + u(this, "marginBottom") + _.height, C = t.extend({}, g), D = c(k.my, a.outerWidth(), a.outerHeight());
        ...
        t.ui.position = {
            fit: {
                left: function(t, e) {
                    ...
                    t.left += l - s) : h > 0 && l <= 0 ? t.left = o : l > h ? t.left = o + a - e.collisionWidth : t.left = o : l > 0 ? t.left += l : h > 0 ? t.left -= h : t.left = i(t.left - r, t.left)
                },
                top: function(t, e) {
                    var s, n = e.within, o = n.isWindow ? n.scrollTop : n.offset.top, a = e.within.height, r = t.top - e.collisionPosition.marginTop, l = o - r, h = r + e.collisionHeight - a - o;
                    e.collisionHeight > a ? l > 0 && h <= 0 ? (s = t.top + l + e.collisionHeight - a - o,
                    t.top += l - s) : h > 0 && l <= 0 ? t.top = o : l > h ? t.top = o + a - e.collisionHeight : t.top = o : l > 0 ? t.top += l : h > 0 ? t.top -= h : t.top = i(t.top - r, t.top)
                }
            },
            flip: {
                left: function(t, e) {
                    var i, n, o = e.within, a = o.offset.left + o.scrollLeft, r = o.width, l = o.isWindow ? o.scrollLeft : o.offset.left, h = t.left - e.collisionPosition.marginLeft, c = h - l, u = h + e.collisionWidth - r - l, d = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, f = -2 * e.offset[0];
                ...
                top: function(t, e) {
                    var i, n, o = e.within, a = o.offset.top + o.scrollTop, r = o.height, l = o.isWindow ? o.scrollTop : o.offset.top, h = t.top - e.collisionPosition.marginTop, c = h - l, u = h + e.collisionHeight - r - l, d = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, p = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, f = -2 * e.offset[1];
    ...
    t.fn.extend({
        disableSelection: (l = "onselectstart"in document.createElement("div") ? "selectstart" : "mousedown",
        function() {
...
*/
    var u, d = "ui-effects-", p = "ui-effects-style", f = "ui-effects-animated", g = t;
    t.effects = {
        effect: {}
    },
    /*!
...
*/
        ...
        o.fn = t.extend(o.prototype, {
            parse: function(s, n, r, l) {
                ...
                this) : "object" === p ? (s instanceof o ? c(a, function(t, e) {
                    ...
                    h[n] && 0 > t.inArray(null, h[n].slice(0, 3)) && (h[n][3] = 1,
    ...
    function() {
        ...
        t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(e, i) {
            t.fx.step[i] = function(t) {
                ("none" === t.end || t.setAttr) && (1 !== t.pos || t.setAttr) || (g.style(t.elem, i, t.end),
                t.setAttr = !0)
            }
        }),
        ...
        t.effects.animateClass = function(e, i, s, r) {
            ...
            return this.queue(function() {
                var i, s = t(this), r = s.attr("class") || "", h = l.children ? s.find("*").addBack() : s;
                h = h.map(function() {
                    return {
                        el: t(this),
                        start: a(this)
                ...
                h = h.map(function() {
                    ...
                    this.diff = function e(i, s) {
                        ...
                        for (n in s)
                            a = s[n],
                            i[n] === a || o[n] || !t.fx.step[n] && isNaN(parseFloat(a)) || (r[n] = a);
                        return r
                    }(this.start, this.end),
                    this
                }),
        ...
        t.fn.extend({
            ...
            toggleClass: (s = t.fn.toggleClass,
            function(e, i, n, o, a) {
    ...
    function() {
        ...
        t.fn.extend({
            effect: function() {
                ...
                if (t.fx.off || !i)
                    return l ? this[l](e.duration, r) : this.each(function() {
                        r && r.call(this)
                    });
                function u(n) {
                    var o = t(this);
                    ...
                    e.mode = h.shift(),
                    !1 === t.uiBackCompat || s ? "none" === e.mode ? (o[l](),
                    a()) : i.call(o[0], e, function i() {
                        o.removeData(f),
                        t.effects.cleanUp(o),
                        "hide" === e.mode && o.hide(),
                        a()
    ...
    t.effects.define("bounce", function(e, i) {
        var s, n, o, a = t(this), r = e.mode, l = "hide" === r, h = "show" === r, c = e.direction || "up", u = e.distance, d = e.times || 5, p = 2 * d + (h || l ? 1 : 0), f = e.duration / p, g = e.easing, m = "up" === c || "down" === c ? "top" : "left", v = "up" === c || "left" === c, b = 0, $ = a.queue().length;
        ...
        a.css("opacity", 0).css(m, v ? -(2 * u) : 2 * u).animate(n, f, g)),
        l && (u /= Math.pow(2, d - 1)),
        (n = {})[m] = o; b < d; b++)
            (s = {})[m] = (v ? "-=" : "+=") + u,
    ...
    t.effects.define("drop", "hide", function(e, i) {
        var s, n = t(this), o = e.mode, a = e.direction || "left", r = "up" === a || "down" === a ? "top" : "left", l = "up" === a || "left" === a ? "-=" : "+=", h = {
            opacity: 0
        };
    ...
    t.effects.define("explode", "hide", function(e, i) {
        var s, n, o, a, r, l, h = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, c = h, u = t(this), d = "show" === e.mode, p = u.show().css("visibility", "hidden").offset(), f = Math.ceil(u.outerWidth() / c), g = Math.ceil(u.outerHeight() / h), m = [];
        function v() {
            m.push(this),
            m.length === h * c && (u.css({
                visibility: "visible"
    ...
    t.effects.define("fold", "hide", function(e, i) {
        ...
        d.clip[r[0]] = o,
        d.clip[r[1]] = 0,
        "show" === n && (s.cssClip(d.clip),
        h && h.css(t.effects.clipToBox(d)),
        d.clip = c),
        s.queue(function(i) {
            h && h.animate(t.effects.clipToBox(u), l, e.easing).animate(t.effects.clipToBox(d), l, e.easing),
            i()
        }).animate(u, l, e.easing).animate(d, l, e.easing).queue(i),
    ...
    t.effects.define("size", function(e, i) {
        ...
        ("box" === d || "both" === d) && (n.from.y !== n.to.y && (v = t.effects.setTransition(a, l, n.from.y, v),
        b = t.effects.setTransition(a, l, n.to.y, b)),
        n.from.x !== n.to.x && (v = t.effects.setTransition(a, h, n.from.x, v),
        b = t.effects.setTransition(a, h, n.to.x, b))),
        ("content" === d || "both" === d) && n.from.y !== n.to.y && (v = t.effects.setTransition(a, r, n.from.y, v),
        b = t.effects.setTransition(a, r, n.to.y, b)),
    ...
    t.effects.define("slide", "show", function(e, i) {
        var s, n, o = t(this), a = {
            ...
            left: ["right", "left"],
            right: ["left", "right"]
        }, r = e.mode, l = e.direction || "left", h = "up" === l || "down" === l ? "top" : "left", c = e.distance || o["top" === h ? "outerHeight" : "outerWidth"](!0), u = {};
        t.effects.createPlaceholder(o),
        s = o.cssClip(),
        n = o.position()[h],
...
*/
    t.ui.focusable = function(e, i) {
        ...
        !!e.href && !!n && "map" === s.nodeName.toLowerCase() && (o = t("img[usemap='#" + n + "']")).length > 0 && o.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(l) ? (a = !e.disabled) && (r = t(e).closest("fieldset")[0]) && (a = !r.disabled) : a = "a" === l && e.href || i,
        a && t(e).is(":visible") && function t(e) {
    ...
    t.widget("ui.accordion", {
        ...
        _eventHandler: function(e) {
            ...
            e.preventDefault(),
            (!r || n.collapsible) && !1 !== this._trigger("beforeActivate", e, u) && (n.active = !l && this.headers.index(a),
            this.active = r ? t() : a,
            this._toggle(u),
        ...
        _animate: function(t, e, i) {
            ...
            e.length) ? t.length ? void (s = t.show().outerHeight(),
    ...
    t.widget("ui.menu", {
        ...
        nextPage: function(e) {
            ...
            !this.isLastItem() && (this._hasScroll() ? (s = this.active.offset().top,
        ...
        previousPage: function(e) {
            ...
            !this.isFirstItem() && (this._hasScroll() ? (s = this.active.offset().top,
            n = this.element.height(),
...
*/
    ...
    function v() {
        ...
        this.dpDiv = b(t("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    function b(e) {
    ...
    function $() {
        t.datepicker._isDisabledDatepicker(a.inline ? a.dpDiv.parent()[0] : a.input[0]) || (t(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
    ...
    t.widget("ui.controlgroup", {
        ...
        _setOption: function(t, e) {
            if ("direction" === t && this._removeClass("ui-controlgroup-" + this.options.direction),
            this._super(t, e),
            "disabled" === t) {
...
*/
    t.widget("ui.button", {
        ...
        _updateIcon: function(e, i) {
            ...
            this._attachIcon(n),
            "top" === n || "bottom" === n ? (this._addClass(this.icon, null, "ui-widget-icon-block"),
    ...
    t.fn.button = (s = t.fn.button,
    function() {
        return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? s.apply(this, arguments) : (t.ui.checkboxradio || t.error("Checkboxradio widget missing"),
    ...
    t.extend(v.prototype, {
        ...
        _showDatepicker: function(e) {
            ...
            !t.datepicker._isDisabledDatepicker(e) && t.datepicker._lastInput !== e)
                ...
                !1 !== (n = (s = t.datepicker._get(i, "beforeShow")) ? s.apply(e, [e, i]) : {}) && (y(i.settings, n),
                i.lastVal = null,
                ...
                i.dpDiv.css("z-index", function t(e) {
                    for (var i, s; e.length && e[0] !== document; ) {
                        if (("absolute" === (i = e.css("position")) || "relative" === i || "fixed" === i) && (s = parseInt(e.css("zIndex"), 10),
                        !isNaN(s) && 0 !== s))
                            return s;
                        e = e.parent()
                    }
        ...
        parseDate: function(e, i, s) {
            ...
            if ("" === (i = "object" == typeof i ? i.toString() : i + ""))
                return null;
            var n, o, a, r, l = 0, h = (s ? s.shortYearCutoff : null) || this._defaults.shortYearCutoff, c = "string" != typeof h ? h : new Date().getFullYear() % 100 + parseInt(h, 10), u = (s ? s.dayNamesShort : null) || this._defaults.dayNamesShort, d = (s ? s.dayNames : null) || this._defaults.dayNames, p = (s ? s.monthNamesShort : null) || this._defaults.monthNamesShort, f = (s ? s.monthNames : null) || this._defaults.monthNames, g = -1, m = -1, v = -1, b = -1, $ = !1, y = function(t) {
            ...
            for (n = 0; n < e.length; n++)
                if ($)
                    ...
                    case "y":
                        ...
                        break;
                    case "@":
                        g = (r = new Date(_("@"))).getFullYear(),
                        m = r.getMonth() + 1,
                        v = r.getDate();
                        break;
                    case "!":
                        g = (r = new Date((_("!") - this._ticksTo1970) / 1e4)).getFullYear(),
                        m = r.getMonth() + 1,
                        v = r.getDate();
                        break;
                    case "'":
            ...
            b > -1)
                for (m = 1,
                v = b; !(v <= (o = this._getDaysInMonth(g, m - 1))); )
                    m++,
                    v -= o;
        ...
        _generateHTML: function(t) {
            ...
            s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>" : j ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>",
            n = this._get(t, "nextText"),
            n = q ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt,Z + V,1)), this._getFormatConfig(t)) : n,
            o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + n + "</span></a>" : j ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + n + "</span></a>",
            ...
            h = Y ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (B ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (B ? "" : l) + "</div>" : "",
            ...
            y = ""; w < K[0]; w++) {
                ...
                this.maxRows = 4; x < K[1]; x++) {
                    ...
                    X) {
                        ...
                        K[1] > 1)
                            ...
                            case 0:
                                ...
                                D = " ui-corner-" + (B ? "right" : "left");
                                break;
                            case K[1] - 1:
                                P += " ui-datepicker-group-last",
                                D = " ui-corner-" + (B ? "left" : "right");
                                break;
                            default:
                    ...
                    for (P += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === w ? B ? o : s : "") + (/all|right/.test(D) && 0 === w ? B ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, w > 0 || x > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    T = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
                    _ = 0; _ < 7; _++)
                        I = (_ + c) % 7,
                        T += "<th scope='col'" + ((_ + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[I] + "'>" + p[I] + "</span></th>";
                    ...
                    A = 0; A < z; A++) {
                        for (P += "<tr>",
                        W = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(O) + "</td>" : "",
                        _ = 0; _ < 7; _++)
                            E = m ? m.apply(t.input ? t.input[0] : null, [O]) : [!0, ""],
                            F = (N = O.getMonth() !== Z) && !b || !E[0] || Q && O < Q || J && O > J,
                            W += "<td class='" + ((_ + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (N ? " ui-datepicker-other-month" : "") + (O.getTime() === C.getTime() && Z === t.selectedMonth && t._keyEvent || $.getTime() === O.getTime() && $.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (F ? " " + this._unselectableClass + " ui-state-disabled" : "") + (N && !v ? "" : " " + E[1] + (O.getTime() === G.getTime() ? " " + this._currentClass : "") + (O.getTime() === R.getTime() ? " ui-datepicker-today" : "")) + "'" + ((!N || v) && E[2] ? " title='" + E[2].replace(/'/g, "&#39;") + "'" : "") + (F ? "" : " data-handler='selectDay' data-event='click' data-month='" + O.getMonth() + "' data-year='" + O.getFullYear() + "'") + ">" + (N && !v ? "&#xa0;" : F ? "<span class='ui-state-default'>" + O.getDate() + "</span>" : "<a class='ui-state-default" + (O.getTime() === R.getTime() ? " ui-state-highlight" : "") + (O.getTime() === G.getTime() ? " ui-state-active" : "") + (N ? " ui-priority-secondary" : "") + "' href='#'>" + O.getDate() + "</a>") + "</td>",
                    ...
                    ++Z > 11 && (Z = 0,
                    tt++),
                    P += "</tbody></table>" + (X ? "</div>" + (K[0] > 0 && x === K[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""),
                    k += P
                }
                y += k
            }
        ...
        _generateMonthYearHeader: function(t, e, i, s, n, o, a, r) {
            var l, h, c, u, d, p, f, g, m = this._get(t, "changeMonth"), v = this._get(t, "changeYear"), b = this._get(t, "showMonthAfterYear"), $ = "<div class='ui-datepicker-title'>", y = "";
            if (o || !m)
...
*/
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i, s) {
            var n, o, a, r, l, h, c, u, d, p, f = s.options, g = f.snapTolerance, m = i.offset.left, v = m + s.helperProportions.width, b = i.offset.top, $ = b + s.helperProportions.height;
            for (d = s.snapElements.length - 1; d >= 0; d--) {
                if (h = (l = s.snapElements[d].left - s.margins.left) + s.snapElements[d].width,
                ...
                "inner" !== f.snapMode && (n = Math.abs(c - $) <= g,
                o = Math.abs(u - b) <= g,
                a = Math.abs(l - v) <= g,
                r = Math.abs(h - m) <= g,
                ...
                p = n || o || a || r,
                "outer" !== f.snapMode && (n = Math.abs(c - b) <= g,
                o = Math.abs(u - $) <= g,
                a = Math.abs(l - m) <= g,
                r = Math.abs(h - v) <= g,
                n && (i.position.top = s._convertPositionTo("relative", {
...
*/
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseStop: function(e) {
            ...
            return this._helper && (n = (s = (i = this._proportionallyResizeElements).length && /textarea/i.test(i[0].nodeName)) && this._hasScroll(i[0], "left") ? 0 : this.sizeDiff.height,
...
*/
    ...
    t.ui.ddmanager = {
        ...
        drop: function(e, i) {
            ...
            return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && w(e, this, this.options.tolerance, i) && (s = this._drop.call(this, i) || s),
        ...
        drag: function(e, i) {
            ...
            t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var s, n, o, a = w(e, this, this.options.tolerance, i), r = !a && this.isover ? "isout" : a && !this.isover ? "isover" : null;
        ...
        _mouseDrag: function(e) {
            ...
            !this.options.disabled) {
                ...
                this.selectees.each(function() {
                    ...
                    "touch" === n.tolerance ? h = !(c.left > r || c.right < o || c.top > l || c.bottom < a) : "fit" === n.tolerance && (h = c.left > o && c.right < r && c.top > a && c.bottom < l),
    ...
    t.widget("ui.selectmenu", [t.ui.formResetMixin, {
        ...
        open: function(t) {
            if (!this.options.disabled)
                this._rendered ? (this._removeClass(this.menu.find(".ui-state-active"), null, "ui-state-active"),
        ...
        _resizeButton: function() {
            ...
            null === t && (t = this.element.show().outerWidth(),
            this.element.hide()),
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        values: function(e, i) {
            ...
            for (o = 0,
            s = this.options.values,
            n = arguments[0]; o < s.length; o += 1)
            ...
            if (d) {
                if (1 === this.containers.length)
                    ...
                    if (this.currentContainer === this.containers[p]) {
                        this.currentContainer.containerCache.over || (this.containers[p]._trigger("over", e, this._uiHash()),
...
*/
    t.widget("ui.tabs", {
        ...
        _findNextTab: function(e, i) {
            ...
            for (; -1 !== t.inArray(n(), this.options.disabled); )
                e = i ? e + 1 : e - 1;
            return e
        },
